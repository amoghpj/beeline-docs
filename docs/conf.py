...
project = u'BEELINE'
copyright = u'2019, Aditya Pratapa'
author = u'Aditya Pratapa, Amogh Jalihal'

# The short X.Y version
version = u''
# The full version, including alpha/beta/rc tags
release = u''
html_logo = 'figs/beeline.svg'
...
exclude_patterns = ['../BoolODE/src/cluster-vis.py',
                    '../BoolODE/src/timecourse-vis.py',
                    '../BoolODE/src/dim-red-vis.py',
                    '../BoolODE/src/genSamples.py',
                    '../BoolODE/src/genMonocleInputs.py',
                    '../BoolODE/src/genBooleanFromNet.py',                                        
]

# The name of the Pygments (syntax highlighting) style to use.
pygments_style = 'monokai' #monokai'
...
# 'searchbox.html']``.
#
# html_theme_options = {'github_user':'murali-group',
#                       'github_repo':'Beeline',
#                       'github_button':True}
...
latex_documents = [
    (master_doc, 'BoolODE.tex', u'BoolODE Documentation',
     u'Amogh Jalihal', 'manual'),
]
...
man_pages = [
    (master_doc, 'boolode', u'BoolODE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BoolODE', u'BoolODE Documentation',
     author, 'BoolODE', 'One line description of project.',
     'Miscellaneous'),
]
